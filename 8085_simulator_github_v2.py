...
def byte_8085(mnemonic):
    ...
    mnemonic = mnemonic.split()
    opcode = mnemonic[0]
    one_byte = ["MOV", "ADD", "CMA", "INR", "INX", "DCR", "DCX", "LDAX", "STAX", "HLT", "SUB"]
    two_byte = ["MVI", "IN", "ADI", "ORI", "ACI", "SUI"]
    three_byte = ["LDA", "LXI", "STA", "JMP","CALL", "LHLD", "SHLD", "JC", "JNC", "JZ", "JNZ"]
